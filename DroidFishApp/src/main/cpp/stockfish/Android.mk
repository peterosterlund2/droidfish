...
SF_SRC_FILES := \
	...
	bitboard.cpp evaluate.cpp misc.cpp search.cpp tt.cpp polybook.cpp syzygy/tbprobe.cpp

MY_DEF := -DSullivan -DAdd_Features -DReleaseVer
MY_ARCH_DEF :=
...
LOCAL_CFLAGS    := -std=c++11 -O2 -fPIE $(MY_ARCH_DEF) $(MY_DEF) -s
